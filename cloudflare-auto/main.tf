  ...
  config {
    ...
    dynamic "ingress_rule" {
      for_each = {
        ...
        record.name => record
        if record.zero_trust != null ? (record.zero_trust.tunnel != null ? (record.zero_trust.tunnel.name == each.key ? true : (record.zero_trust.tunnel.name != each.key && record.zero_trust.tunnel.name == null)) : false) : false
      }
      content {
