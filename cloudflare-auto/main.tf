  ...
  config {
    ...
    dynamic "ingress_rule" {
      for_each = {
        ...
        record.name => record
        if record.zero_trust != null ? (record.zero_trust.tunnel != null ? ((each.key != var.default_tunnel_name && record.zero_trust.tunnel.name == each.key) ? true : each.key == var.default_tunnel_name) : false) : false
      }
      content {
